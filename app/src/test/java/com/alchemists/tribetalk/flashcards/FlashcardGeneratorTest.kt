...
class FlashcardGeneratorTest {
    ...
    fun testHindiEditTriggersSantaliRetranslation() {
        ...
        assertTrue(result.santaliText.contains("Puthi", ignoreCase = true) || result.santaliText.contains("ᱯᱩᱛᱷᱤ"))
    }
    ...
    fun testTeacherManualSantaliEditPreservation() {
        ...
        // Verify TranslationMemory is untouched
