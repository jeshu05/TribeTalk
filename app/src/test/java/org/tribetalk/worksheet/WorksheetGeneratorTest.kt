...
class WorksheetGeneratorTest {
    ...
    fun testHindiEditTriggersRetranslation() {
        ...
        assertTrue("Santali translation should contain translated phrase", santaliResult.contains("ᱯᱩᱛᱷᱤ") || santaliResult.contains("Puthī") || santaliResult.contains("ᱡᱷᱤᱡᱽ"))
    }
